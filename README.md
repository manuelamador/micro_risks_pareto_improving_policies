...
There is a Jupyter notebook associated with the script that can be run instead. Run [Jupyter](https://jupyter.org/) and navigate to `scripts` to locate the notebook and run it.
